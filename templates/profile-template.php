                        ...
                        <?php foreach($posts as $post): ?>
                            <article class="profile__post post post-<?=$post['type_class'];?>">
                                <header class="post__header">
                                    <?php if ($post['repost']) :?>
                                        <div class="post__author">
                                            <a class="post__author-link" href="profile.php?id=<?= $post['original_author_id'] ?? '' ?>" title="Автор">
                                                <div class="post__avatar-wrapper post__avatar-wrapper--repost">
                                                    <img class="post__author-avatar" src="img/<?= $post['original_author_avatar'] ?? '' ?>" alt="Аватар пользователя">
                                                </div>
                                ...
                                <footer class="post__footer">
                                    ...
                                    <time class="post__time" datetime="<?= $post['dt_add'] ?? '' ?>"><?= absolute_time_to_relative($post['dt_add']); ?></time>
                                    </div>

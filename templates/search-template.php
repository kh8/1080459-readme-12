          ...
          <header class="post__header post__author">
            <a class="post__author-link" href="profile.php?id=<?= $post['author_id'] ?? '' ?>" title="Автор">
              ...
              <div class="post__info">
                ...
                datetime="<?= $post['dt_add'] ?>"><?= absolute_time_to_relative($post['dt_add'], 'назад'); ?></time>
                <?php endif; ?>
              </div>
            </a>
          </header>
          <h2>
            <a href="post.php?id=<?= $post['id'] ?>"><?= $post['title'] ? htmlspecialchars($post['title']) : '' ?></a>
          </h2>
            ...
            switch ($post['type_class']) :
                ...
                case 'link':
                    ...
                    <div class="post-link__wrapper">
                      ...
                      href="<?= $post['content'] ? htmlspecialchars($post['content']) : '' ?>"

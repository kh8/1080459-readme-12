...
function repost_post($connection, $user_id, $post_id)
{
    ...
    $repost = 1;
    $repost_query = "INSERT INTO posts (author_id, dt_add, repost, original_post_id, view_count,
    original_author_id, post_type, title, content, quote_author, img_url, youtube_url, url)
